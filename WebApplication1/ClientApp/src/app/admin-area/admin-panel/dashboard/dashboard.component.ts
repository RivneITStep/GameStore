...
export class DashboardComponent implements OnInit {
  ...
  constructor(
    ...
    public pieChartColors = [
      {
        backgroundColor: [
          'rgba(119, 25, 207, 0.3)', 'rgba(142, 69, 209, 0.3)',
          'rgba(164, 113, 212, 0.3)', 'rgba(111, 69, 150, 0.3)',
          'rgba(96, 70, 121, 0.3)', 'rgba(59, 38, 78, 0.3)',
          'rgba(211, 182, 236, 0.3)', 'rgba(42, 0, 78, 0.3)',
          'rgba(97, 32, 155, 0.3)', 'rgba(96, 0, 121, 0.3)',
          'rgba(164, 32, 212, 0.3)', 'rgba(119, 0, 207, 0.3)',
          'rgba(59, 38, 155, 0.3)', 'rgba(70, 36, 100, 0.3)',
          'rgba(126, 78, 138, 0.3)', 'rgba(116, 3, 145, 0.3)']
      },
    ];
    pieChartType = 'pie';
